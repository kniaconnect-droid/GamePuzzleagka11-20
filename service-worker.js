...
const CACHE_NAME = "puzzle-angka-ceria-v3";
...
const PRECACHE_URLS = [
  ...
  "./assets/brand/kelinci-mascot.png",
  "./assets/brand/background.jpg",
  "./assets/brand/angka11_new.png",
  "./assets/brand/angka13_new.png",
  "./assets/brand/angka17_new.png",
  "./assets/brand/angka20_new.png",

  "./assets/icons/icon-192.png",
  "./assets/icons/icon-512.png",
  "./assets/icons/icon-512-maskable.png",
  "./assets/icons/home.png",
  "./assets/icons/butterfly1.png",
  "./assets/icons/butterfly2.png",
